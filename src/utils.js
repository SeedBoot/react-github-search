...
export const gitHubUrl = (lang, numberOfResults) =>
  `https://api.github.com/search/repositories?q=language:${lang}+created:>${gitHubMonthQuery}&sort=stars&per_page=${numberOfResults}`;
